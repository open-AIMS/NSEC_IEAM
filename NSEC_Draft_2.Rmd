...
ggsave("figure 2.png", height=120, width=200, units="mm")
...
ggplot(aes(label, y)) +
 ...
 ggsave("figure 3.png", height=160, width=240, units="mm")
```
##Figure 4 
...
ggsave("figure 4.png", height=180,width=200, units="mm")
...
ggsave("figure 5.png", height=180, width=200,units="mm" )
