...
fig_dir <- "C:/Users/dkoppel/Australian Institute of Marine Science/Program 2.3 - TERA - General/Projects/3158 Statistical Ecotoxicology/Estimating no effect/MS/revision1/"
...
png("figure curves.png", height=120, width=200, units="mm", bg = "white", res = 2000)
par(bty="n")
...
ggsave("figure simdat.png", height=180, width=200,units="mm", bg = "white")
...
ggsave("figure sims_comb.png", height=200, width=200, units="mm", bg = "white")
ggsave(paste(fig_dir,"figure 1.png", sep=""), height=200, width=200, units="mm", bg = "white")
```
...
ggsave("figure weights.png", height=200, width=200, units="mm", bg = "white")
ggsave(paste(fig_dir,"figure 2.png", sep=""), height=200, width=200, units="mm", bg = "white")
...
ggplot(aes(label, y)) +
 ...
 ggsave("figure nsec.png", height=160, width=240, units="mm", bg = "white")
...
ggsave("figure all_estimates.png", height=200, width=240, units="mm", bg = "white")
ggsave(paste(fig_dir,"figure 3.png", sep=""), height=200, width=240, units="mm", bg = "white")

plot_grid(a2, e2, labels=c("A", "B"), ncol = 1, nrow = 2, rel_heights = c(0.5, 0.5))

ggsave("figure all_effects.png", height=200, width=240, units="mm", bg = "white")
ggsave(paste(fig_dir,"figure 4.png", sep=""), height=200, width=240, units="mm", bg = "white")
...
ggsave("figure 5.png", height=180,width=200, units="mm", bg = "white")
ggsave(paste(fig_dir,"figure 5.png", sep=""), height=180,width=200, units="mm", bg = "white")
...
(fig.cs2<-ggplot()+
  ...
  new_scale_color()+
  new_scale_fill()+
  geom_segment(data=cs_endpoints_2, aes(x=med, xend=med, y=0, yend=1, colour=endpoint),lwd=0.8)+
...
ggsave("figure cs2.png", height=180, width=200,units="mm", bg = "white")
ggsave(paste(fig_dir,"figure 6.png", sep=""), height=180,width=200, units="mm", bg = "white")
...
ggsave("figure all_effects_.png", height=160, width=240, units="mm", bg = "white")
...
ggsave("figure all_estimates.png", height=160, width=240, units="mm", bg = "white")
...
ggplot(aes(label, y)) +
 ...
 ggsave("figure effects.png", height=160, width=240, units="mm", bg = "white")
