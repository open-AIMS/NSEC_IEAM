...
a1 <- dat %>%
  ...
  ggplot(aes(x=endpoint, y=y, fill=n.treatments)) +
  ...
  facet_grid(scenarios_f ~ label, scales = "free_y") +
  theme_minimal() +
...
plot_grid(a1, a2, labels=c("A", "B"), ncol = 1, nrow = 2, rel_heights = c(0.5, 0.5))

ggsave("figure all_estimates.png", height=300, width=240, units="mm", bg = "white")
ggsave(paste(fig_dir,"figure 3.png", sep=""), height=300, width=240, units="mm", bg = "white")
...
plot_grid(e1, e2, labels=c("A", "B"), ncol = 1, nrow = 2, rel_heights = c(0.5, 0.5))

ggsave("figure all_effects.png", height=240, width=240, units="mm", bg = "white")
ggsave(paste(fig_dir,"figure 4.png", sep=""), height=240, width=240, units="mm", bg = "white")
