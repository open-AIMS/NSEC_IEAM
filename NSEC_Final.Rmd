...
ggsave(paste(fig_dir,"figure 1.jpg", sep=""), height=200, width=200, units="mm", 
       bg = "white", dpi = 300)
```
...
ggsave(paste(fig_dir,"figure 2.jpg", sep=""), height=200, width=200, units="mm", 
       bg = "white", dpi = 300)
...
ggsave(paste(fig_dir,"figure 3.jpg", sep=""), height=200, width=240, units="mm", 
       bg = "white", dpi = 300)

plot_grid(a2, e2, labels=c("A", "B"), ncol = 1, nrow = 2, rel_heights = c(0.5, 0.5))

ggsave(paste(fig_dir,"figure 4.jpg", sep=""), height=200, width=240, units="mm", 
       bg = "white", dpi = 300)
...
cu_dat <- readxl::read_excel("ignore/Cryo combined with id.xlsx") %>% 
  rename(x=conc) %>% 
...
ggsave(paste(fig_dir,"figure 5.jpg", sep=""), height=180,width=200, units="mm", 
       bg = "white", dpi = 300)
...
ggsave(paste(fig_dir,"figure 6.jpg", sep=""), height=180,width=200, units="mm", 
       bg = "white", dpi = 300)
